    ...
    <>
      ...
      >
        <div className="mx-auto mt-8 flex max-w-4xl flex-col items-center justify-center gap-6 text-lg sm:gap-8 sm:text-2xl lg:mt-20 lg:gap-10 lg:text-4xl">
          <div className="w-full py-4 text-center wrap-break-word">
            ☎ +886 905-599-158
          </div>
          <div className="w-full py-4 text-center wrap-break-word">
            ☎ +1 341-248-9147
          ...
          <div className="w-full py-4 text-center wrap-break-word">
            ✉ bensonhsieh2006@gmail.com
          </div>
          <div className="flex w-full items-center justify-center gap-3 py-4 text-center break-all sm:gap-4">
            <FontAwesomeIcon
              icon={faGithub}
