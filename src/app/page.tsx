  ...
  return (
    <div>
      ...
      <main className="relative flex min-h-[calc(100dvh-15vh)] items-center justify-center overflow-hidden bg-[#060812] px-6 py-12 max-[640px]:min-h-[calc(100dvh-4.5rem)]">
        <div className="pointer-events-none absolute top-0 left-1/2 h-[clamp(220px,35dvh,450px)] w-[min(900px,90vw)] -translate-x-1/2 rounded-full bg-blue-600/20 blur-3xl" />
        <div
